...
<strong>Update:</strong> I've added a new post that covers #1 from the above next steps. <a href="/2014/04/07/sinatra-task-manager-part-2-extracting-a-class.html">Check it out here.</a>
